...
export const ApiArModel = ({
  ...
  useEffect(() => {
    const run = async () => {
      ...
      const warningText = userDistanceFromObject > 0 ? `You are approx. ${Math.round(userDistanceFromObject)} meters away from the object. Get within 5 meters to see it in AR.` : `Unable to detect your location, viewing this object in AR is disabled.`
